             ...
             <div className="rightboxVdetails">
               ...
               {/* ` <div className="or">
                    ...
                    <div className="inputoneV" >
						<input type="text" placeholder="Email" onChange={(e)=>{Email(e)}}/>
						</div>
                        <div className="inputoneV" >
						<input type="text" placeholder="Mobile Number"  onChange={(e)=>{Number(e)}}/>
						</div>
                        <div className="inputoneV" >
						<input type="text" placeholder="Full Name"  onChange={(e)=>{Fullname(e)}}/>
						</div>
                        <div className="inputoneV" >
						<input type="text" placeholder="Username"  onChange={(e)=>{Username(e)}}/>
						</div>
						<div className="inputoneV" >
						<input type="password" placeholder="Password"  onChange={(e)=>{Password(e)}} />
						</div>
                        <div className="inputoneV" >
						<input type="password" placeholder="Date Of Birth"  onChange={(e)=>{DOB(e)}} />
						</div>
						<div className="inputoneV" >
						<input type="submit" value="Log In" className="InpButtV"  onClick={(e)=>{Signupdata(e)}}/>
						</div>
					</form>
